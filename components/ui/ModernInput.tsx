...
// ModernSearchInput component - specialized search input
export const ModernSearchInput: React.FC<Omit<ModernInputProps, 'variant'>> = (props) => {
  return <ModernInput {...props} variant="search" />;
};
